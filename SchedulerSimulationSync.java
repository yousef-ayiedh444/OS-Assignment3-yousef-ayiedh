...
class SharedResources {
    ...
    // LOCK FOR PROTECTONG SHERED COUNTERS 
    ...
    //SEMAPHORE TO CONTROL CPU ACCESS - Only 1 process can execute at a time
...
class Process implements Runnable {
    ...
    public void run() {
        ...
        //ACQUIRE CPU ACCESS BEFORE EXECUTING
        try {
...
public class SchedulerSimulationSync {
    public static void main(String[] args) {
        ...
        int studentID = 444051021;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
